...
public class JSFunctionDefImpl extends JSClassDefImpl implements JSFunctionDef {

  public JSFunctionDefImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public JSFunArgs getFunArgs() {
    return findNotNullChildByClass(JSFunArgs.class);
  }
  ...
  public int getArgsLength() {
    return JSPsiImplUtil.getArgsLength(this);
  }
