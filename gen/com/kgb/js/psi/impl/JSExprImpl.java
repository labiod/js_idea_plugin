...
public class JSExprImpl extends JSExpressionImpl implements JSExpr {

  public JSExprImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public JSPrimaryInner getPrimaryInner() {
    return findNotNullChildByClass(JSPrimaryInner.class);
  }

  public JSClass getType() {
    return JSPsiImplUtil.getType(this);
  }
