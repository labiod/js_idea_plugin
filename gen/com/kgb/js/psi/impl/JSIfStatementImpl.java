...
public class JSIfStatementImpl extends JSPsiBaseImpl implements JSIfStatement {
  ...
  @Override
  @NotNull
  public List<JSElseIfStatement> getElseIfStatementList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, JSElseIfStatement.class);
  }
