...
public class JSCondExprImpl extends JSPsiBaseImpl implements JSCondExpr {

  public JSCondExprImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<JSExpr> getExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, JSExpr.class);
  }
