...
public class JSPropArrayInnerImpl extends JSPsiBaseImpl implements JSPropArrayInner {

  public JSPropArrayInnerImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JSVisitor visitor) {
    visitor.visitPropArrayInner(this);
  }
