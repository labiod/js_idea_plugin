...
public class JSElseIfStatementImpl extends JSPsiBaseImpl implements JSElseIfStatement {

  public JSElseIfStatementImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public JSElseStatement getElseStatement() {
    return findChildByClass(JSElseStatement.class);
  }
